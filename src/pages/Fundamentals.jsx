      ...
      <div className="min-h-screen py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <PageHeader
            ...
            description="The building blocks of Finance & Legal in AIESEC"
          />

          <InfoCard title="What is Accounting?" delay={0.1} icon={Book} colorClass="text-blue-500" variant="featured">
            <p>
          ...
          <InfoCard title="What is Finance?" delay={0.2} icon={TrendingUp} colorClass="text-green-500">
            <p>
          ...
          <InfoCard title="What are Legalities?" delay={0.3} icon={ShieldCheck} colorClass="text-red-500">
            <p>
          ...
          <InfoCard title="What are Accounting Standards?" delay={0.4} icon={PieChart} colorClass="text-purple-500">
            <p>
